...
public abstract class Animal {
    ...
    /*
        ...
        6)To make a method abstract
            ...
            iii)Change the "concrete class" to "abstract class" by using abstract keyword
            between "access modifier" and "class" keyword
            Note: After creating an abstract method do not forget to use the method in all
         ...
         9)"final" methods must have "constant method body" but in abstraction every child class
          will use the "abstract method" with a different body.
           Because of that, Java does not let you make an abstract method "final".
           I mean "public final abstract void drink();" gives error.
         10)An "abstract class" cannot be "final" because; final class cannot have child classes
          but abstract class should have child classes
