...
public class Sets001 {
    ...
    public static void main(String[] args) {
        ...
        myLhs.add(32);
        myLhs.add(null);
        System.out.println("myLhs = " + myLhs);
        ...
        System.out.println("myLhs = " + myLhs);
        System.out.println("myLhs.size() = " + myLhs.size());
        ...
        Interview Question: What do you use to store unique elements in natural order?
                            ...
                            Answer: Create HashSet, add elements into HashSet then convert it to TreeSet.
         */
