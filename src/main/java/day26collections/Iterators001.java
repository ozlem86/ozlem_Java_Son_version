...
public class Iterators001 {
    ...
    5) There are two types of iterators i)Iterator: It can just "remove" the elements.
                                                    It is not possible to update collection.
                                                    It works just from left to right.

                                       ii)ListIterator: It can remove, update and add elements.
                                                        It works both from left to right
                                                         and right to left.
     */
