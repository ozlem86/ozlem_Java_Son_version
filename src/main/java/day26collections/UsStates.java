...
public enum UsStates {
    /*
        1)Enum is a storage to store constant data your application needs
          For example; For "Car Sale" application you need "Car Makes" that is why you have to store
           "Car Makes" in your application. That kind of constant data is stored in Enums.
     */
    ...
    public static void main(String[] args) {
        String a= UsStates.ALABAMA.abbreviation;
        String b=UsStates.ALASKA.capital;
