...
public class Queue001 {
    ...
    public static void main(String[] args) {
        ...
        que.add("Brad");
        que.add("Jim");
        System.out.println("que = " + que);//[Tom, Ajda, Brad, Jim] => Elements are in insertion order because I used LinkedList as constructor.
        ...
        System.out.println("dq = " + dq);//[Tom, Ajda, Brad, Jim, Aaron, Cindy] => Elements are in insertion order because I used LinkedList as constructor.
        //If you look at methods in Deque, you will notice the methods are ...first(9 and ...last()
