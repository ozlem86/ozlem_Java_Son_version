...
public class Sets01 {
    /*
        ...
        There are 3 sets i)HashSet: Uses hashing technique.
                         ...
                         iii)TreeSet: TreeSet puts the elements in natural order,
                         putting elements in natural order needs too much time
                                      that is why TreeSet is so slow.
                                      Set lerin hepsi tekrarsiz data icerir. tekrar olmaz.
     */
    ...
    public static void main(String[] args) {
        ...
        /*
            Interview Question: What do you use to store unique elements in natural order?
                                ...
                                Answer: Create HashSet, add elements into the HashSet,
                                 then convert the HashSet to TreeSet
         */
