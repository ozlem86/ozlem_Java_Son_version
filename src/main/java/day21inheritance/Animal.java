...
public class Animal {
  ...
  *
        ...
        3)The method in child class(Overriding Method) can use "same" or "wider"
        * access modifier than the method in parent class(Overridden Method)
        4)When you change the "return type" in "method overriding", from child to parent
        *  you must have "IS-A" relationship.
        ...
        7)Between the "Wrapper Classes" there is no "parent-child relationship" that is why you cannot
...
​
         ...
         What is the difference between "Method Overloading" and "Method Overriding"?
            i)"Method Overriding" needs "inheritance" but
            * "Method Overloading" occurs in a single class we do not need "inheritance"
