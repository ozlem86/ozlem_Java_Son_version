...
public interface Ac {
    ...
    //1) By using "default" keyword before "return type" of the method,
    // you can create "method with body" in an interface
    //2) When you create "bacteriaKiller() default method", "Honda Concrete Child Class"
    // will not complain, because Overriding is mandatory for "abstract methods" but
    // "bacteriaKiller() default method" is not abstract.
