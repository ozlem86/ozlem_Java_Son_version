...
public class Arrays02 {
    public static void main(String[] args) {
        ...
        /*
        // 2.Way
        //binarySearch(char, int,...) bir Array de specifik bir karakter olup olmadigini arar.
        //mutlaka once sort() method kullanmak gerekir.

        Arrays.sort(ch);
        int idx1= Arrays.binarySearch(ch,'Y');// burada indexi ni verir.kacinci indexte oldugunu soyler
                                         //eger o element arays de yoksa -(sayi) verir.
        System.out.println(idx1);

        int idx2= Arrays.binarySearch(ch,'G');
        System.out.println(idx2);//-4 cunku alfabetik sirada bu sirada olurdu
